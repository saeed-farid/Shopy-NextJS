  ...
  const controlNavbar = () => {
    if (typeof window !== 'undefined') {
      if (window.scrollY > 150) {
        setnavheight('parent-nav-tow')
        setnighticon('night-icon upper-icon')
        setnavheighdarker('parent-nav-tow darker')
        setnighticontire('night-icon upper-icon tire')
      }
      else {
      ...
      <div className={styles.container}>
        <Carousel onPrevEnd={(currentItem, pageIndex) =>
          ...
          src="/../images/rbrb.png"
              ...
              height={1000}
              alt="عکس موجود نیست"
              className={isActive ? 'my-image image-smaller' : 'my-image dark-img image-smaller'} >
